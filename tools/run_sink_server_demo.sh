...
$LLUTILS_HOME/build/lls/echo_server -s -l 7575 &
sleep 1
...
$LLUTILS_HOME/build/lls/socket_client_non_blocking -p 6565 -s "test" -r 5 -w 1000 

sleep 1
echo "sending 5 test messages from socket client (wait time 999999999 nanos)"
$LLUTILS_HOME/build/lls/socket_client_non_blocking -p 6565 -s "test" -r 5 -w 999999999

sleep 1
echo "running  socket client in interactive mode:"
$LLUTILS_HOME/build/lls/socket_client_non_blocking -p 6565 -i
